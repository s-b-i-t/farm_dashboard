...
const HomePage = () => {
  return (
    <div className="container" style={{  marginLeft: '100px', marginRight: '100px' }}>
      ...
      <img src={image2} alt="Spring Valley Student Farm Mission" class="image-container"></img>
      ...
      <img src={image1} alt="Spring Valley Student Farm Mission" class="image-container"></img>
